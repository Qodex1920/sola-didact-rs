...
export const ResultDisplay: React.FC<ResultDisplayProps> = ({ asset, loading, loadingMessage }) => {
  if (loading) {
    return (
      <div className="w-full h-96 bg-gray-100 rounded-xl flex flex-col items-center justify-center animate-pulse border border-gray-200">
        <div className="w-12 h-12 border-4 border-sola-primary border-t-transparent rounded-full animate-spin mb-4" />
  ...
  if (!asset) {
    return (
      <div className="w-full h-96 bg-gray-50 rounded-xl flex flex-col items-center justify-center border border-gray-200 text-gray-400">
        <svg
        ...
        <p>Le résultat apparaitra ici</p>
      </div>
    );
  }
    ...
    <div className="w-full bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
      <div className="p-4 border-b border-gray-100 flex justify-between items-center bg-gray-50">
        ...
        <a
          ...
          className="text-sola-primary hover:text-sola-primary/80 text-sm font-medium flex items-center gap-1"
        >
          <svg
            className="w-4 h-4"
            fill="none"
      ...
      <div className="p-2 flex items-center justify-center bg-gray-50 min-h-[300px]">
        {asset.type === 'video' ? (
          <video
            src={asset.url}
            controls
